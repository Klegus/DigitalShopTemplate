...
export default function CartPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-8 text-center text-gray-800 dark:text-gray-100">{t('cart_page_title')}</h1>
      ...
      {cartItems.length === 0 ? (
        <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md text-center border border-gray-200 dark:border-gray-700">
          ...
          <p className="text-gray-600 dark:text-gray-300 text-lg mb-6">{t('empty_cart_message')}</p>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden border border-gray-200 dark:border-gray-700">
          <div className="bg-gray-50 dark:bg-gray-700 px-6 py-4 hidden md:grid md:grid-cols-12 border-b border-gray-200 dark:border-gray-600">
            <div className="col-span-6 font-medium text-gray-600 dark:text-gray-300">{t('cart_header_product')}</div>
            <div className="col-span-2 font-medium text-gray-600 dark:text-gray-300 text-center">{t('cart_header_quantity')}</div>
            <div className="col-span-2 font-medium text-gray-600 dark:text-gray-300 text-right">{t('cart_header_price')}</div>
            <div className="col-span-2 font-medium text-gray-600 dark:text-gray-300 text-right">{t('cart_header_subtotal')}</div>
          </div>
          ...
          <div className="bg-gray-50 dark:bg-gray-700 p-6 md:flex md:justify-between md:items-center">
            ...
            <div className="text-right">
              <div className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">
                {t('cart_total')}: <span className="text-blue-600 dark:text-blue-400">${getCartTotal().toFixed(2)}</span>
              </div>
              <button
